...
//        retrofit = new Retrofit.Builder().baseUrl("http://192.168.11.104:8036").addConverterFactory(new NullOnEmptyConverterFactory()).addConverterFactory(GsonConverterFactory.create(new Gson())).build();
    }
